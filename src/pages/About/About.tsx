  ...
  return (
    <div>
      <section data-section-name="landing-page-hero-section">
        <div className="py-10 md:py-4 md:min-h-screen bg-[url('/hero-image.png')] bg-cover bg-center bg-no-repeat relative ">
          <div className="flex flex-col justify-center items-center gap-4 pt-[3rem]">
            ...
            <h3 className="flex flex-col gap-10 md:flex-row text-5xl font-extrabold text-white">
              <TextAnimate>
                We support.
              </TextAnimate>
              <TextAnimate>
      ...
      <section className="bg-black rounded-3xl mt-[-10px]">
        <div className="p-10">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 text-[#B3B2B0]">
            <div>
              <p className="mb-5">
      ...
      <section>
        <div className="py-[8rem] my-10">
          <div className="flex flex-col text-center mx-auto w-[60%] md:w-[30%]">
            <div>
